...
import { AuthXero } from '../providers/xero-account.entity'
...
export class Account extends BaseEntity {
  ...
  @OneToMany(() => AuthXero, (xeroAccount) => xeroAccount.account)
  @ApiProperty()
  xeroAccounts: AuthXero[]
  ...
  @Column({ nullable: true, name: 'agreement_signed_at' })
  @ApiProperty()
