...
export class CreatePaymentLinkMetadataDto {
  ...
  @IsNotEmpty()
  @IsEthereumOrSolanaAddress({ message: 'fromAddress must be a valid Ethereum or Solana address' })
  fromAddress: string

  @ApiProperty({ example: '0x0000000000000000000000000000000000000000' })
  @IsNotEmpty()
  @IsEthereumOrSolanaAddress({ message: 'toAddress must be a valid Ethereum or Solana address' })
  toAddress: string
