...
export class BlockchainsDetailedDto {
  ...
  @ApiProperty({
    example: 'https://safe-transaction-mainnet.safe.global'
  })
  safeUrl: string

  @ApiProperty({
    example: 'https://mainnet.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161'
  })
  rpcUrl: string
  ...
  static map(blockchain: Blockchain): BlockchainsDetailedDto {
    ...
    result.safeUrl = blockchain.safeUrl ?? null
    result.rpcUrl = blockchain.rpcUrl ?? null
