...
const resource = 'integration_sync_requests'
const actions = ['create', 'read', 'update', 'delete']
export class addPermissionForIntegrationSyncRequests1688127333555 implements MigrationInterface {
  name = 'addPermissionForIntegrationSyncRequests1688127333555'
