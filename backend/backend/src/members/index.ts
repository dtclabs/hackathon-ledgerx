...
export class ProfileDto {
  ...
  public static map(member: Member) {
    console.log(`contacts: `, member?.profile?.contacts)
...
export class AddressDto {
  ...
  public static map(address: MemberAddress) {
    ...
    addressDto.tokenId = address.token?.id?.toString()
...
export class ContactDto {
  ...
  public static map(address: MemberContact): ContactDto {
    const contactDto = new ContactDto()
    contactDto.providerId = address.contactProvider?.id?.toString()
    contactDto.content = address.content
    return contactDto
  }
}
