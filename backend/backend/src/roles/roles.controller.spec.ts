...
describe('RolesController', () => {
  ...
  let rolesService: RolesEntityService
  ...
  beforeEach(async () => {
    ...
    const app: TestingModule = await Test.createTestingModule({
      ...
      providers: [RolesEntityService, { provide: getRepositoryToken(Role), useClass: Repository }]
    })
    ...
    rolesService = app.get<RolesEntityService>(RolesEntityService)
