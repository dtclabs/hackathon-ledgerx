...
@Entity()
@Index('IDX_tax_lot_walletId_blockchainId', ['walletId', 'blockchainId'])
@Index('IDX_tax_lot_childId', ['financialTransactionChildId'])
@Index('IDX_tax_lot_organizationId_blockchainId', ['organizationId', 'blockchainId'])
