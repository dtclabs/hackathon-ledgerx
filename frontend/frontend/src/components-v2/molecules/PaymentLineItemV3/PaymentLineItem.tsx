            ...
            <div className="basis-1/2">
              <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  height={48}
                  data-tip="usdt-disabled"
                  data-for="usdt-disabled"
                ...
                {isAddRecipientDisabled && (
                  ...
                  >
                    USDT transfers using an EOA wallet can only be done one at a time. To perform a batch transfer with
                    USDT, please use a Safe wallet.
                  </ReactTooltip>
                )}
                <Button
                  variant="grey"
              ...
              {errors?.tokenId && <HelperText img={ErrorCircleIcon} helperText={errors?.tokenId?.message} />}
            </div>
          </div>
