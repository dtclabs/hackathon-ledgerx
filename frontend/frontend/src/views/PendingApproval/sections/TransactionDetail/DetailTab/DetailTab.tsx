...
const DetailTab: FC<IDetailTabProps> = ({
  ...
  const url = `https://app.safe.global/transactions/queue?safe=${SAFE_CHAIN_MAP[transaction?.blockchainId]}:${
  ...
  return (
    <div className={`mt-6 h-[calc(100vh-160px)] flex flex-col ${transaction?.isRejected ? '' : 'justify-between'}`}>
          ...
          {transaction?.isUnknown ? (
            <div className="mt-6">
              <div className="border border-[#EAECF0] text-center rounded py-2">
                <Typography classNames="mb-1">We currently only support transfer transactions.</Typography>
                <Typography color="secondary">
                  For details on this transaction, please refer to the{' '}
                  <a
                    href={url}
      ...
      <section id="cta-buttons" className="flex mb-4  flex-1 items-end">
