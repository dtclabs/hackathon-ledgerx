  ...
  const handleSubmitRecipients = () => {
    ...
    data?.forEach((recipient) => {
      if (recipient.isValid) {
        ...
        const recipientName =
          (existedRecipient?.contactName || existedRecipient?.organizationName || existedSource?.name) ?? null
        const recipientId =
          existedRecipient?.recipientAddresses.find((recipientObj) => recipientObj.address === recipient.walletAddress)
