    ...
    <>
      <div className="font-inter border-[1px] border-dashboard-border rounded-lg rounded-tl-none overflow-auto scrollbar w-full">
        <div className="min-w-fit">
          <div className="bg-grey-100 flex items-center py-[13px] border-b-[1px]">
            <Typography variant="caption" color="secondary" classNames="pl-6 w-[8%] min-w-[92px]">
              Lot#
            </Typography>
            ...
            <Typography variant="caption" color="secondary" classNames="pl-6 w-[12%] min-w-[140px]">
              Lot Amount
            </Typography>
            <Typography variant="caption" color="secondary" classNames="pl-6 w-[12%] min-w-[140px]">
              Lot Price
            ...
            <Typography variant="caption" color="secondary" classNames="pl-6 w-[10%] min-w-[100px]">
              Last Update
            </Typography>
            <Typography variant="caption" color="secondary" classNames="pl-6 w-[12%] min-w-[120px]">
              Wallet
            </Typography>
            <Typography variant="caption" color="secondary" classNames="pl-6 w-[22%] min-w-[220px]">
              Remaining Amount
            </Typography>
          </div>
        </div>
