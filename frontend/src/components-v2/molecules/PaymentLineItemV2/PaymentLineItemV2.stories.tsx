...
import PaymentLineItemV2 from './PaymentLineItemV2'

export default {
  title: 'Molecules/Payment Line Item V2',
  component: PaymentLineItemV2,
  argTypes: {
    backgroundColor: { control: 'color' }
  }
} as Meta<typeof PaymentLineItemV2>
...
const Template: StoryFn<typeof PaymentLineItemV2> = (args) => {
