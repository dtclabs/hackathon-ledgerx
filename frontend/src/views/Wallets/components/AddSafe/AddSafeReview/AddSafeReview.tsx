...
const AddSafeReview: React.FC<IAddSafeReview> = ({ safeInfo, safeError, organizationContacts }) => (
  ...
  <>
    {safeError ? (
      ...
      <div className="w-full">
        ...
        <div className="flex">
          <Typography variant="body2">{safeInfo.address}</Typography>
          <WalletAddressActionButtons address={safeInfo.address} />
        </div>
