...
// checks if the WalletGroupRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletGroupRef{}

// WalletGroupRef struct for WalletGroupRef
type WalletGroupRef struct {
...
func (o WalletGroupRef) MarshalJSON() ([]byte, error) {
...
func (o WalletGroupRef) ToMap() (map[string]interface{}, error) {
...
type NullableWalletGroupRef struct {
	value *WalletGroupRef
	isSet bool
}

func (v NullableWalletGroupRef) Get() *WalletGroupRef {
	return v.value
}

func (v *NullableWalletGroupRef) Set(val *WalletGroupRef) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletGroupRef) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletGroupRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletGroupRef(val *WalletGroupRef) *NullableWalletGroupRef {
	return &NullableWalletGroupRef{value: val, isSet: true}
}

func (v NullableWalletGroupRef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletGroupRef) UnmarshalJSON(src []byte) error {
	v.isSet = true
